...
export default function Navbar({ onChatToggle, onProfileToggle }: NavbarProps) {
  return (
    <nav id="top-navbar">
      <div className="nav-content">
        ...
        <div className="nav-links">
          <a href="#" onClick={e => { e.preventDefault(); onChatToggle() }}>
          ...
          <a href="#" onClick={e => { e.preventDefault(); onProfileToggle() }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-icon">
