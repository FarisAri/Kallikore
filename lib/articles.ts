...
export const DUMMY_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    content: "Full article text... (dummy data). In a historic move, representatives from 140 nations agreed to the 'Paris 2.0' protocol. The treaty mandates strict AI-driven energy routing grids to be installed by 2030, aiming to drop global emissions by a further 15%.",
  },
  {
    id: 3,
    ...
    content: "Full article text... (dummy data). Venture capital is flooding into New South Wales as a new generation of AI startups set up shop in Sydney. The government's new tech-visa program has brought in top talent from around the globe.",
  },
]
